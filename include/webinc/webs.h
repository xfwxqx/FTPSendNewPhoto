...
#define WEBS_XML_VAP			0x100000
#define WEBS_GET_REQUEST		0x200000
/*
 *	URL handler flags
 */
...
#endif
#ifdef WEBS_XMLVAP_SUPPORT
	websvapRequestCallback	reqCallback;
	void *					preqCallbackContext;
	char_t *					prspbuf;
	int						rspLen;
